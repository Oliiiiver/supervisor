...
window.Badges = (function () {
  ...
  const LIST = [
    ...
    },
    {
      ...
      name: "权倾朝野",
      desc: "累计刷 2500 题",
      icon: icon('<rect x="11" y="5" width="10" height="6"/><path d="M13 11h6v4h-6z"/><rect x="5" y="15" width="22" height="7"/><path d="M3 27h26"/>'),
    ...
    },
    {
      ...
      name: "尧行舜举",
      desc: "累计刷 3000 题",
      icon: icon('<path d="M3 8h26l-3 5H6z"/><path d="M8 13v4a8 8 0 0 0 16 0v-4"/><path d="M11 24v5M16 26v4M21 24v5"/>'),
      test: ctx => ctx.totalQuestions >= 3000,
    },
    {
      id: "drill-210",
      name: "文治景昌",
      desc: "累计刷 3500 题",
      icon: icon('<circle cx="16" cy="7" r="4"/><path d="M4 14h9a3 3 0 0 1 3 3v10a3 3 0 0 0-3-2H4z"/><path d="M28 14h-9a3 3 0 0 0-3 3v10a3 3 0 0 1 3-2h9z"/>'),
      test: ctx => ctx.totalQuestions >= 3500,
    },
    {
      id: "drill-240",
      name: "祯祥观盛",
      desc: "累计刷 4000 题",
      icon: icon('<circle cx="11" cy="14" r="6"/><path d="M11 4v2M11 22v2M3 14h2M19 12h1"/><path d="M27 10a8 8 0 1 0-4 14 9 9 0 0 1 4-14z"/><path d="M6 28h20"/>'),
      test: ctx => ctx.totalQuestions >= 4000,
    },
    {
      id: "drill-300",
      name: "史昭民穆",
      desc: "累计刷 5000 题",
      icon: icon('<path d="M6 4v24M11 4v24M16 4v24M21 4v24M26 4v24"/><path d="M4 10h24M4 22h24"/>'),
      test: ctx => ctx.totalQuestions >= 5000,
    },
